...
NEURON {
    ...
    RANGE gkbar, m_inf1, tau_m, h_inf, tau_h1, ik, Q10KiA, gbQ10KiA, tauMmax, Vh1m, Vs1m, Vh2m, Vs2m, CMM, VhMinf, VsMinf, tauHmax, Vh1h, Vs1h, Vh2h, Vs2h, CHH, VhHinf, VsHinf
}
...
PROCEDURE evaluate_fct(v(mV)) {  LOCAL a
	tadj = Q10KiA^((celsius-20)/10) 
	gbtadj =gbQ10KiA^((celsius-20)/10)
