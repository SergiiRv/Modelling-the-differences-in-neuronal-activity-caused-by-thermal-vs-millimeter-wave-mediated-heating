...
NEURON {
        ...
        RANGE gkbar, betanbarS, alphanbarS, alphanvh, alphanvs, betanvh, betanvs, Q10KdelRec, gbQ10KdelRec
        :GLOBAL ninf, nexp  
}
...
BREAKPOINT {
		dbq10 = gbQ10KdelRec^((celsius - 20)/10)
        SOLVE states
